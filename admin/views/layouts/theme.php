...
<div class="offcanvas offcanvas-end" tabindex="-1" id="theme-settings-offcanvas">
    <div class="d-flex align-items-center gap-2 px-3 py-3 offcanvas-header border-bottom border-dashed">
        <h5 class="flex-grow-1 mb-0">Opciones del tema</h5>
    ...
    <div class="offcanvas-body p-0 h-100" data-simplebar>
        <div class="p-3 border-bottom border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Esquema de colores</h5>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Oscuro</h5>
                </div>
            </div>
        </div>

        <div class="p-3 border-bottom border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Color del header</h5>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Azul</h5>
                </div>
                ...
                <div class="col-3">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Gradiente</h5>
                </div>
            </div>
        </div>

        <div class="p-3 border-bottom border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Color del menú</h5>
        ...
        <div class="p-3 .border-bottom .border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Tamaño del menú</h5>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Vista completa</h5>
                </div>
