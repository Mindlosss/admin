...
class ThemeCustomizer {
        ...
        if (menuToggleBtn) {
            menuToggleBtn.addEventListener('click', function () {
                ...
                if (size === 'full') {
                    ...
                    } else if (configSize == 'sm-hover') {
                        if (size === 'sm-hover') {
                            self.changeLeftbarSize(configSize == 'sm-hover' ? 'sm-hover-active' : configSize, true);
                        } else {
                            self.changeLeftbarSize('sm-hover', true);
                        }

                    } else if (configSize == 'sm-hover-active') {
                        if (size === 'sm-hover-active') {
                            self.changeLeftbarSize(configSize == 'sm-hover-active' ? 'sm-hover' : configSize, true);
                        } else {
                            self.changeLeftbarSize('sm-hover-active', true);
                        }
    ...
    setSwitchFromConfig() {
        ...
        sessionStorage.setItem('__ABSTACK_CONFIG__', JSON.stringify(this.config));
